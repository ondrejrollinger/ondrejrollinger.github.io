...
| **2.4 (current)** | Given a scenario, analyze indicators of malicious activity. | <span class="status-badge done">done</span> |
...
[← Back to Dashboard]({{ '/secplus/' | relative_url }}) | [Next: Objective 2-5 →]({{ '/secplus/objectives/2-5/' | relative_url }})
