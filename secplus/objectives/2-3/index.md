...
| **2.3 (current)** | Explain various types of vulnerabilities. | <span class="status-badge done">done</span> |
...
[← Back to Dashboard]({{ '/secplus/' | relative_url }}) | [Next: Objective 2-4 →]({{ '/secplus/objectives/2-4/' | relative_url }})
