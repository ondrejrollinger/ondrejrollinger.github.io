...
Early on, at the end of Phase 1, I asked the pipeline to test itself: submit three deliberately broken firmware variants and see if the Reviewer would actually catch them.
